...
type LoadKind = 'read-later' | 'favorite' | 'archive'
type RemoveField = 'favorite' | 'archive' | 'read_later'
...
export default function StateList({
  ...
  useEffect(() => {
    ...
    const fetcher =
      loadKind === 'read-later'
        ? (params: { page: number; pageSize: number }) => api.listReadLater(params)
        : (params: { page: number; pageSize: number }) =>
            api.listEntries({ ...params, [loadKind]: true })
