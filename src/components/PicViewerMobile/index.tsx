...
export interface PicViewerMobileDialogProps {
  open: boolean
...
export interface PicViewerMobileProps {
  src?: string | null
  alt?: string
  title?: string
  filePath?: string
...
function PicViewerMobileDialog({
  ...
  function clampTranslate(tx: number, ty: number, s: number): { x: number; y: number } {
